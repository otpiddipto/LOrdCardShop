<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCard.aspx.cs" Inherits="LordCardShop.Views.Admin.AddCard" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                ...
                <br />
                <asp:Button ID="btnSubmit" runat="server" Text="Add Card" OnClick="btnSubmit_Click" />
